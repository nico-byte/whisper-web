### Stolen from https://github.com/MahmoudAshraf97/whisper-diarization/blob/main/helpers.py
import os
import shutil
...
def format_timestamp(milliseconds: float, always_include_hours: bool = True, decimal_marker: str = ","):
...
def process_language_arg(language: str, model_name: str):
    ...
    if language is not None:
        ...
        if model_name.endswith(".en") and language != "en":
            raise ValueError(f"{model_name} is an English-only model but choosen language is '{language}'")
